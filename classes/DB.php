<?php
	...
	abstract class DB
	{
		...
		public static function getAllActors()
		{
			...
			$stmt = $connection->prepare("
				SELECT a.id as 'actor_id', a.first_name, a.last_name, a.favorite_movie_id, m.title AS 'favorite_movie', m.id
				FROM actors as a
			...
			foreach ($actors as $actor) {
			  ...
			  $finalActor->setMovieId($actor['favorite_movie_id']);
				$finalActor->setTitle($actor['favorite_movie']);
